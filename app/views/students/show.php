            ...
            <!-- Card body Start -->
                <div class= "bg-white shadow rounded-lg p-4 " >
                   ...
                   <div class="space-y-2">
                        ...
                        <input value="<?= $student['phone_number']?>" class="w-full px-4 py-2 border rounded-lg " type="text" id="phone_number" placeholder="Masukkan nama" name="phone_number" readonly>
                    </div>
