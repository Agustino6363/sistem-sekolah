...
<body class="min-h-screen flex flex-col bg-gray-100 ">
   ...
   <header class="bg-blue-500 text-white">
        <div class="flex items-center justify-between container mx-auto p-4">
           ...
           <a href="/students/create" class="bg-white text-blue-500 px-4 py-2 rounded-lg"> Detail siswa</a> 
        </div>
   </header>
   <!-- Header end -->
    ...
    <main class="container mx-auto grow">
        <div class="mt-8 space-y-2">
            ...
            <div class="p-4 shadow rounded-lg bg-white">
                ...
                <p>Menambahkan detail siswa yang terdaftar</p>
            </div>
            <!-- Card Header End -->
            ...
            <!-- Card body Start -->
                <div class= "bg-white shadow rounded-lg p-4 " >
                   ...
                   <div class="space-y-2">
                        ...
                        <input class="w-full px-4 py-2 border rounded-lg " type="text" id="phone_number" placeholder="Masukkan nama" name="phone_number" readonly>
                    </div>
